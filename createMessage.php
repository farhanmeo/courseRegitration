...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="subject" name = "subject" placeholder="Subject Of The Message">
    </div>
  </div>
   ...
   <div class="form-group">
    ...
    <div class="col-sm-10">
      <textarea type="text" class="form-control" name = "message" id="message" placeholder="Enter The Message " style = "width : 500px ; height : 200px;"></textarea>
    </div>
  </div>
...
if (isset ($_POST['submit'])) 
		...
		$sql = "INSERT INTO cs.sent_message
		( reciever_id , sender_id ,subject , message )
		VALUES 
		('$id','$senderId','$subject','$message')";

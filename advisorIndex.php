...
$fallSpring = $_SESSION['fallSpring'];
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            ...
            <li class="active"><a href="paIndex.php"><i class="fa fa-dashboard"></i> Assistant Panel</a></li>
            <li><a href="student.php"><i class="fa fa-bar-chart-o"></i> View Your Students</a></li>
            <li><a href="studentInfo.php"><i class="fa fa-table"></i> View By Course</a></li>
            <li><a href="updateStudentInformation.php"><i class="fa fa-edit"></i> Allocate Teacher</a></li>
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3><?php echo $id ?>  Panel</h3>
           
            <div class="alert alert-success alert-dismissable">
              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
              Welcome to Course Registration System Start Your Work</a>
